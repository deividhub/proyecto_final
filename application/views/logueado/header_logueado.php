<body>
	<header  id="header_logueado">
		...
		<ul id="ul_index_logueado">
		    ...
		    <li class="icon_logueado" id="log_perfil"><a href="<?php echo base_url();?>index.php/Principal/perfil_usuario"><i class="material-icons">person</i><span class="tooltiptext">Visita tu perfil</span></a></li>
